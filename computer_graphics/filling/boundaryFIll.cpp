...
void boundaryFill(int x , int y, Color fillColor, Color boundaryColor){
    ...
    // printf("Point %d, %d\t Color %f %f %f\n",x,y,interiorColor.r,interiorColor.g,interiorColor.b);
    if (((int)interiorColor.r != (int)fillColor.r || (int)interiorColor.g != (int)fillColor.g || (int)interiorColor.b != (int)fillColor.b) &&
        ((int)interiorColor.r != (int)boundaryColor.r || (int)interiorColor.g != (int)boundaryColor.g || (int)interiorColor.b!= (int)boundaryColor.b))
     {
